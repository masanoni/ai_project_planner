      ...
      sortableItems.sort((a, b) => {
        ...
        switch(sortConfig.key) {
            ...
            case 'task':
                ...
                break;
            case 'dueDate':
                aValue = a.subStep.dueDate || '9999-12-31'; // Put items without due date at the end
                bValue = b.subStep.dueDate || '9999-12-31';
                break;
        }
            ...
            <tbody className="divide-y divide-slate-200">
              {sortedItems.map(({ actionItem, subStep, task }, index) => (
                <tr key={actionItem.id + index} className="hover:bg-slate-50">
                  ...
                  <td className="px-6 py-3">{subStep.dueDate ? new Date(subStep.dueDate + 'T00:00:00Z').toLocaleDateString('ja-JP', { year: 'numeric', month: 'long', day: 'numeric'}) : '未設定'}</td>
                </tr>
              ))}
